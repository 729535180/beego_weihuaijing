...
<head>
    ...
    <!-- 浏览器标签图片 -->
    <link rel="shortcut icon" href="/static/admin/topjui/images/favicon.ico"/>
    <!-- TopJUI框架样式 -->
    <link type="text/css" href="/static/admin/topjui/themes/default/topjui.core.min.css" rel="stylesheet">
    <link type="text/css" href="/static/admin/topjui/themes/default/topjui.blue.css" rel="stylesheet" id="dynamicTheme"/>
    <!-- FontAwesome字体图标 -->
    <link type="text/css" href="/static/admin/static/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet"/>
    <!-- jQuery相关引用 -->
    <script type="text/javascript" src="/static/admin/static/plugins/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="/static/admin/static/plugins/jquery/jquery.cookie.js"></script>
    <!-- TopJUI框架配置 -->
    <script type="text/javascript" src="/static/admin/static/public/js/topjui.config.js"></script>
    <!-- TopJUI框架核心 -->
    <script type="text/javascript" src="/static/admin/topjui/js/topjui.core.min.js"></script>
    <!-- TopJUI中文支持 -->
    <script type="text/javascript" src="/static/admin/topjui/js/locale/topjui.lang.zh_CN.js"></script>
    <!-- 首页js -->
    <script type="text/javascript" src="/static/admin/static/public/js/topjui.index.js" charset="utf-8"></script>
...
<div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
        ...
        <div class="nav-bar">
            <div class="nav-left webname">
                <span class="fa fa-envira" style="font-size:26px; padding-right:4px;"></span>TopJUI前端框架
                <span class="collapseMenu " style="text-align: center;cursor: pointer;font-size: 18px;padding-left: 5px;">
            ...
            <div class="nav-center">
                ...
                <div style="overflow: hidden;position: relative;text-align: left">
                    <ul class="nav-group">
                        <li id="1325" title="TopJUI静态演示" style="" class="topmenu  selected">
                        ...
                        <li id="9000" class="topmenu">
                            <a class="l-btn-text bannerMenu" href="http://demo.misboot.com/system/login?from=topjui_demo" target="_blank">
                                <p>
                                    <lable class="fa fa-leaf" style="color: #2F4056;"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">动态演示</span></p>
                            </a>
                        </li>
                        <li id="9001" class="topmenu">
                            <a class="l-btn-text bannerMenu" href="http://www.topjui.com" target="_blank">
                                <p>
                        ...
                        <li id="9002" class="topmenu">
                            <a class="l-btn-text bannerMenu" href="http://ask.topjui.com" target="_blank" >
                                <p>
                        ...
                        <li id="9003" class="topmenu">
                            <a class="l-btn-text bannerMenu" href="javascript:addParentTab({href:'http://www.topjui.com/compile',title:'在线编译'})" >
                                <p>
                                    <lable class="fa fa-code" style="color: rebeccapurple"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">在线调试</span></p>
                            </a>
                        </li>
                        <li id="9004" class="topmenu">
                            <a class="l-btn-text bannerMenu" href="http://www.jeasyui.cn/?from=demo" target="_blank" >
                                <p>
                                    <lable class="fa fa-link" style=""></lable>
                                </p>
    ...
    <div data-options="region:'south',border:true"
        ...
        <span style="padding-right:5px;width:40%">
            ...
            <a href="http://www.beian.miit.gov.cn/" target="_blank">湘ICP备18018053号</a>
        </span>
